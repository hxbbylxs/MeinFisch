...
int evaluate(GameBoard const & board, int alpha, int beta) {
    ...
    eval_info.mg_evaluation += eval_info.num_attackers_black_small_zone*eval_info.num_attackers_black_small_zone;
    eval_info.eg_evaluation += eval_info.num_attackers_black_small_zone*eval_info.num_attackers_black_small_zone;
    eval_info.mg_evaluation -= eval_info.num_attackers_white_small_zone*eval_info.num_attackers_white_small_zone;
    eval_info.eg_evaluation -= eval_info.num_attackers_white_small_zone*eval_info.num_attackers_white_small_zone;
...
void evaluateKnights(GameBoard const &board, EvalInfo & eval_info) {
    ...
    forEachPiece(Constants::WHITE_KNIGHT,board,[&](int position, GameBoard const & game_board) {
        ...
        // mobility
        uint64_t possible_moves = ~board.white_pieces & attacked_squares & ~eval_info.squares_attacked_by_less_valuable_black_pieces;
    ...
    forEachPiece(Constants::BLACK_KNIGHT,board,[&](int position, GameBoard const & game_board) {
        ...
        //mobility
        uint64_t possible_moves = ~board.black_pieces & attacked_squares & ~eval_info.squares_attacked_by_less_valuable_white_pieces;
        any_game_phase_evaluation -= KNIGHT_BONUS_PER_SQUARE*__builtin_popcountll(possible_moves);
...
void evaluateRooks(GameBoard const &board, EvalInfo & eval_info) {
    ...
    forEachPiece(Constants::WHITE_ROOK,board,[&](int position, GameBoard const & game_board) {
        ...
        // mobility
        eval_info.eg_evaluation += __builtin_popcountll(attacked_squares & ~eval_info.squares_attacked_by_less_valuable_black_pieces);
    ...
    forEachPiece(Constants::BLACK_ROOK,board,[&](int position, GameBoard const & game_board) {
        ...
        // mobility
        eval_info.eg_evaluation -= __builtin_popcountll(attacked_squares & ~eval_info.squares_attacked_by_less_valuable_white_pieces);
        ...
        eval_info.eg_evaluation -= PST_EG_BLACK_ROOK[position];
    });
