...
// from PeSTO evaluation function
// mg: middle game    eg: end game

inline constexpr std::array<int,Constants::NUM_SQUARES> mg_white_pawn_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_black_pawn_table = {
    82, 82, 82, 82, 82, 82, 82, 82,
    47, 81, 62, 59, 67, 106, 120, 60,
    56, 78, 78, 72, 85, 85, 115, 70,
    55, 80, 77, 94, 99, 88, 92, 57,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_white_pawn_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_black_pawn_table = {
    94, 94, 94, 94, 94, 94, 94, 94,
    107, 102, 102, 104, 107, 94, 96, 87,
    98, 101, 88, 95, 94, 89, 93, 86,
    107, 103, 91, 87, 87, 86, 97, 93,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_white_knight_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_black_knight_table = {
    232, 316, 279, 304, 320, 309, 318, 314,
    308, 284, 325, 334, 336, 355, 323, 318,
    314, 328, 349, 347, 356, 354, 362, 321,
    324, 341, 353, 350, 365, 356, 358, 329,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_white_knight_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_black_knight_table = {
    252, 230, 258, 266, 259, 263, 231, 217,
    239, 261, 271, 276, 279, 261, 258, 237,
    258, 278, 280, 296, 291, 278, 261, 259,
    263, 275, 297, 306, 297, 298, 285, 263,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_white_bishop_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_black_bishop_table = {
    332, 362, 351, 344, 352, 353, 326, 344,
    369, 380, 381, 365, 372, 386, 398, 366,
    365, 380, 380, 380, 379, 392, 383, 375,
    359, 378, 378, 391, 399, 377, 375, 369,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_white_bishop_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_black_bishop_table = {
    274, 288, 274, 292, 288, 281, 292, 280,
    283, 279, 290, 296, 301, 288, 282, 270,
    285, 294, 305, 307, 310, 300, 290, 282,
    291, 300, 310, 316, 304, 307, 294, 288,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_white_rook_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_black_rook_table = {
    458, 464, 478, 494, 493, 484, 440, 451,
    433, 461, 457, 468, 476, 488, 471, 406,
    432, 452, 461, 460, 480, 477, 472, 444,
    441, 451, 465, 476, 486, 470, 483, 454,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_white_rook_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_black_rook_table = {
    503, 514, 515, 511, 507, 499, 516, 492,
    506, 506, 512, 514, 503, 503, 501, 509,
    508, 512, 507, 511, 505, 500, 504, 496,
    515, 517, 520, 516, 507, 506, 504, 501,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_white_queen_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_black_queen_table = {
    1024, 1007, 1016, 1035, 1010, 1000, 994, 975,
    990, 1017, 1036, 1027, 1033, 1040, 1022, 1026,
    1011, 1027, 1014, 1023, 1020, 1027, 1039, 1030,
    1016, 999, 1016, 1015, 1023, 1021, 1028, 1022,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_white_queen_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_black_queen_table = {
    903, 908, 914, 893, 931, 904, 916, 895,
    914, 913, 906, 920, 920, 913, 900, 904,
    920, 909, 951, 942, 945, 953, 946, 941,
    918, 964, 955, 983, 967, 970, 975, 959,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_white_king_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> mg_black_king_table = {
    -15, 36, 12, -54, 8, -28, 24, 14,
    1, 7, -8, -64, -43, -16, 9, 8,
    -14, -14, -22, -46, -44, -30, -15, -27,
    -49, -1, -27, -39, -46, -44, -33, -51,
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_white_king_table = {
...
inline constexpr std::array<int,Constants::NUM_SQUARES> eg_black_king_table = {
    -53, -34, -21, -11, -28, -14, -24, -43,
    -27, -11, 4, 13, 14, 4, -5, -17,
    -19, -3, 11, 21, 23, 16, 7, -9,
    -18, -4, 21, 24, 27, 23, 9, -11,
